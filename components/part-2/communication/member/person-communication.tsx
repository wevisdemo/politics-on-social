...
import { GOVERNMENT, OPPOSITION, Member } from './member-data'
          ...
          <div className='w-[200px] tablet:w-[490px] mx-auto whitespace-pre-wrap'>
            <div className='bg-gray text-black p-[20px]'>
              ...
              <ul className='list-disc list-inside text-left wv-b5'>
                ...
                <li>เป็นแคนดิเดตนายกฯ หรือ ผู้ว่าฯ กทม. ช่วง 1 พ.ค. 62 - 31 ส.ค. 65</li>
                <li>เป็นสมาชิกพรรคที่มีตำแหน่งบริหารใน ครม. ช่วง 1 พ.ค. 62 - 31 ส.ค. 65</li>
              </ul>
            </div>
          </div>
        }>
